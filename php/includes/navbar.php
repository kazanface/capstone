    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <a class="btn btn-outline-primary ml-5 mr-3 my-sm-0 btn-sm btn-wrap-text" href="/php/company_pages/cust_register_form.php" role="button">Register</a>
                <div class="dropdown">
                    <button class="btn btn-primary my-sm-0 btn-sm dropdown-toggle btn-wrap-text" type="button" data-toggle="dropdown">
                        Login
                    </button>
